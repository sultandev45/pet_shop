                ...
                <div class="w-100 justify-content-between d-flex">
                    ...
                    <table class="table table-stripped text-dark">
                        ...
                        <tbody>
                            <?php 
                                $i = 1;
                                $qry = $conn->query("SELECT o.*, c.fullname as client from `orders` o inner join tbl_users c on c.user_id = o.client_id where o.client_id = '".$_settings->userdata('user_id')."' order by unix_timestamp(o.date_created) desc ");
