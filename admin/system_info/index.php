	...
	<div class="card card-outline card-primary">
		...
		<div class="card-body">
			...
			<div class="form-group">
				...
				<div class="custom-file">
	              <input type="file" class="custom-file-input rounded-circle" id="customFile" multiple name="website-logo" onchange="displayImg2(this,$(this))">
	              <label class="custom-file-label" for="customFile">Choose file</label>
	            </div>
			</div>
			<div class="form-group d-flex justify-content-center">
				<img height="200px" width="200px" src="<?php echo validate_image($_settings->info('website-logo')) ?>" alt="" id="cimg2" class="img-fluid img-thumbnail">
			</div>
			</form>
		</div>
