...
$order = $conn->query("SELECT o.*,fullname as client FROM `orders` o inner join tbl_users c on c.user_id = o.client_id where o.id = '{$_GET['id']}' ");
if($order->num_rows > 0){
    ...
    <div class="card-body">
        <div class="conitaner-fluid">
            ...
            <table class="table-striped table table-bordered">
                ...
                <tbody>
                    <?php 
                        $olist = $conn->query("SELECT o.*,p.product_name FROM order_list o inner join tbl_products p on o.product_id = p.product_id where o.order_id = '{$id}' ");
